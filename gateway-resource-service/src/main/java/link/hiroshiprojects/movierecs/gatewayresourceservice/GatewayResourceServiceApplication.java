package link.hiroshiprojects.movierecs.gatewayresourceservice;
...
public class GatewayResourceServiceApplication {
	...
	public static void main(String[] args) {
		SpringApplication.run(GatewayResourceServiceApplication.class, args);
	}
