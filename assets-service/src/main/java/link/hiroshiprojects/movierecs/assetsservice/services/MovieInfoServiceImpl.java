...
import link.hiroshiprojects.movierecs.assetsservice.repositories.MovieInfoRepository;
...
public class MovieInfoServiceImpl implements MovieInfoService {
    ...
    public List<MovieInfo> getAll() {
        logger.info("Getting movie details from database...");
        return movieInfoRepository.findAll();
    }

    @Override
    public MovieInfo getById(long movieId) {
        logger.info("Attempting fetch of movie with ID " + movieId + " from database...");
